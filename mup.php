...
<body>
	...
	if(isset($_POST['update']))
	{
		...
		$apper=$_POST['apper'];
		$goal=$_POST['goal'];
  $sql = "UPDATE football.mid SET name='$name', nationality='$nationality', dob='$dob', height='$height', jersy_no='$jersy_no', pos='$pos', bpos='$bpos', apper='$apper', goal='$goal' WHERE jersy_no='$jersy_no'"; 
