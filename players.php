...
<body>
    <div class="banner">
        <div class="navbar">
                      ...
                      <a href="players.php"><img src="https://cdn.freebiesupply.com/images/thumbs/2x/manchester-united-logo.png" class=logo1></a>
                      <ul>
		...
		if($name == "")
{
  ...
  echo'<script>location="player.php"</script>';
	...
	$result = "INSERT INTO football.players (club_id,name, nationality, dob, height, jersy_no, position,bpos) values('$club_id','$name','$nationality','$dob','$height','$jersy_no','$pos','$bpos')";
