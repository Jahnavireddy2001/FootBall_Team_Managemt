...
<body>
  ...
  $sql = "UPDATE players SET club_id='$club_id',name='$name', nationality='$nationality', dob='$dob', height='$height', jersy_no='$jersy_no',apper='$apper' WHERE player_id='$player_id'";
