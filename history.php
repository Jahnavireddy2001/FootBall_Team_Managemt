...
<table >
   <tr>
    ...
    $sql = "SELECT club_id,player_id,name,jersy_no,apper FROM history" ;
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo "<tr><td>" . $row["club_id"] . "</td><td>" . $row["player_id"] . "</td><td>" . $row["name"] . "</td><td>" . $row["jersy_no"] . "</td><td>" . $row["apper"] . "</td></tr>";
    }
}
else {
    echo " results";
